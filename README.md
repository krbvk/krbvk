...
# Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,php,java,c,cpp,discordjs,figma,heroku,linux,mysql,bootstrap,git,react,materialui,nodejs,express,gitlab,kali,mongodb,postgres,prisma,pycharm,supabase,tailwind,ubuntu,vite,nextjs,ps,postman,laravel,androidstudio,angular,arch,debian,bash,vercel,arduino,vscode&perline=9)](https://skillicons.dev)
